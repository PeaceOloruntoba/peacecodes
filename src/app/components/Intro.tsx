    ...
    return(
        <div className="flex justify-around items-center px-36 dark:bg-gray-950">
            ...
            <div className="">
                ...
                <h1 className="text-5xl font-bold text-blue-600 mt-6 mb-2">Peace Oloruntoba</h1>
                <h2 className="text-lg font-semibold text-zinc-600 mb-6">👨‍💻 Aspiring Software Engineer | 🌐 Web Developer | 📱 Mobile App Enthusiast | <br /> 💎 Blockchain Enthusiast | 🚀 Aspiring Innovator </h2>
