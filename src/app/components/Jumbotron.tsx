    ...
    return(
        <div>
            ...
            <div className="">
                ...
                <h2 className="text-lg font-semibold text-zinc-600 mb-8">👨‍💻 Aspiring Software Engineer | 🌐 Web Developer | 📱 Mobile App Developer | <br /> 💎 Blockchain Enthusiast | 🚀 Aspiring Innovator </h2>
