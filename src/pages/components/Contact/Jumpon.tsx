...
export default function Jumpon() {
  return (
    <div className="flex justify-around items-center lg:px-20 md:px-12 sm:px-6 bg-slate-300 dark:bg-gray-950 overflow-hidden">
        ...
        <div className="p-16 px-10 grid gap-5 items-center justify-center">
          ...
          <div className="grid lg:flex">
            <div className="p-12 grid text-slate-800 dark:text-zinc-300 text-xl">
              ...
              <span>
                <p className="py-">You can reach me through these social media platforms:</p>
