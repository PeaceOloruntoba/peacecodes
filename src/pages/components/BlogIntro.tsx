...
export default function BlogIntro() {
    return (
        <div className="flex justify-around items-center lg:px-20 md:px-12 sm:px-6 dark:bg-gray-950">
            <div className="p-16 px-10 flex gap-5 bg-slate-200 dark:bg-slate-950 rounded-xl items-center justify-center">
                <p className="text-5xl text-center px-4">My Blog:</p>
                <div className="">
