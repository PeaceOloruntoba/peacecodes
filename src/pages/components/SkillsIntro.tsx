...
export default function SkillsIntro() {
    return(
        <div className="flex justify-around items-center px-36 dark:bg-gray-950">
            <div className="p-16 flex gap-5 bg-slate-200 dark:bg-slate-950 rounded-xl items-center justify-center">
            <p className="text-5xl text-center px-4">Skill and Expertise:</p>
            <div className="">
